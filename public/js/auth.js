    ...
    <div class="modal-card">
      ...
      <div style="text-align:center;margin-bottom:20px">
        <div style="display:inline-block;padding:12px;background:var(--primary-soft);border-radius:18px;margin-bottom:12px">
          <svg style="width:36px;height:36px" viewBox="0 0 24 24"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z"/></svg>
        </div>
        <h2 style="margin:0 0 6px;font-size:20px;font-weight:800">Google 계정으로 로그인</h2>
        <p style="margin:0;font-size:13.5px;color:var(--text-2);word-break:keep-all">
          학습한 단어, 퀴즈 기록, 받아쓰기, 통계가 계정에 안전하게 보관되어 다른 기기에서도 이어서 학습할 수 있습니다.
        </p>
      </div>

      <div id="g-signin-btn-container" style="display:flex;justify-content:center;margin:18px 0"></div>

      <div style="position:relative;text-align:center;margin:20px 0 16px">
        <hr style="border:none;border-top:1px solid var(--border)" />
        <span style="position:absolute;top:-10px;left:50%;transform:translateX(-50%);background:var(--surface);padding:0 10px;font-size:12px;color:var(--text-3)">또는 이메일로 시작</span>
      </div>

      <form id="quick-email-login-form" style="display:flex;flex-direction:column;gap:10px">
        <input class="input" id="login-email-input" type="email" placeholder="사용할 Google 이메일 입력 (예: user@gmail.com)" required />
        <button type="submit" class="btn btn--primary" style="padding:11px 16px;font-size:14.5px">
          이 계정으로 학습 시작하기
        </button>
      </form>

      <div style="margin-top:16px;padding:12px;border-radius:12px;background:var(--surface-2);font-size:12px;color:var(--text-3);line-height:1.5">
        🔒 학습 데이터는 브라우저 및 계정에 영구 보존되며, 언제든지 JSON 파일로 백업하거나 복원할 수 있습니다.
      </div>
    </div>
  `;
